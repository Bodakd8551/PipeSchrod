...
- **`m2`** *(float, optional)*: Mass of particle 2 [GeV]. If provided, the effective mass $m = \frac{m_1 m_2}{m_1 + m_2}$ is calculated.
...
- **`*targets`** *(str)*: Which plot components to generate:
  ...
  - `"densities"`: Plot of probability volume $|u(r)|^2$.
